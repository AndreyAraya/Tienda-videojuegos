...
<head>
    ...
    <title>TiendaDeJuegos — Soporte</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .support-hero h1 {
            ...
            font-size:3rem; font-weight:700; letter-spacing:2px; text-transform:uppercase;
            margin-bottom:.8rem;
        }
        .support-hero h1 span { color:var(--accent); }
        .support-hero p { color:var(--muted); font-size:1rem; max-width:500px; margin:0 auto; }
        ...
        .status-dot {
            ...
            box-shadow:0 0 6px var(--accent); animation:blink 2s infinite;
        }
        ...
        .contact-card:hover { border-color:rgba(0,229,160,.35); transform:translateY(-3px); }
        ...
        .contact-icon.blue  { background:rgba(0,120,255,.12); color:#4da6ff; }
        .contact-icon.purple{ background:rgba(130,80,255,.12); color:#a78bfa; }
        .contact-icon.red   { background:rgba(255,80,80,.1);   color:#ff6b6b; }

        .contact-label {
            font-size:.72rem; font-weight:600; letter-spacing:1px;
            text-transform:uppercase; color:var(--muted);
        }
        .contact-title { font-family:'Rajdhani',sans-serif; font-size:1.15rem; font-weight:700; }
        .contact-value { font-size:.85rem; color:var(--muted); }
        .contact-cta {
            display:inline-flex; align-items:center; gap:.4rem;
            font-size:.8rem; color:var(--accent); font-weight:600; margin-top:.3rem;
        }
        .contact-cta i { font-size:.7rem; transition:transform .2s; }
        ...
        .faq-list { display:flex; flex-direction:column; gap:.7rem; margin-bottom:3rem; }
        ...
        .faq-question i { color:var(--muted); transition:transform .3s; font-size:.8rem; }
        ...
        .day-name { font-size:.65rem; color:var(--muted); text-transform:uppercase; margin-bottom:.4rem; }
        .day-bar-wrap { height:60px; background:var(--border); border-radius:4px; display:flex; align-items:flex-end; overflow:hidden; }
        .day-bar { width:100%; background:linear-gradient(180deg,var(--accent),var(--accent2)); border-radius:4px; transition:height .5s ease; }
        .day-hours { font-size:.65rem; color:var(--muted); margin-top:.4rem; }
        .day-col.today .day-name { color:var(--accent); }
        .day-col.today .day-bar { background:linear-gradient(180deg,#fff,var(--accent)); }
